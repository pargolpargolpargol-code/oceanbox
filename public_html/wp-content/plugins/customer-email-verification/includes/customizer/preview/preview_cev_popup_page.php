									...
									<div class="cev-pin-verification__row">
										<div class="cev-field cev-field_size_extra-large cev-field_icon_left cev-field_event_right cev-field_text_center">
											...
											*
											...
											<input class="cev_pin_box" style="text-align:<?php echo wp_kses_post( get_option('cev_content_align', 'center') ); ?>; display:none;" id="cev_pin1" name="cev_pin1" type="text" placeholder="Enter <?php echo wp_kses_post( apply_filters( 'cev_verification_code_length', __( '4-digits code', 'customer-email-verification' ) ) ); ?>">
											<?php 
