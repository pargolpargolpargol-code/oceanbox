...
$cev_login_hide_otp_section =  get_option('cev_login_hide_otp_section', $CEV_Customizer_Options->defaults['cev_login_hide_otp_section'] );
?>
					...
					<section class="cev-authorization__holder" style="text-align: <?php echo wp_kses_post( get_option('cev_content_align', 'center') ); ?>;  padding: <?php echo wp_kses_post( get_option('cev_widget_content_padding', '40') ); ?>px; ">
						...
						<div class="cev-authorization__heading">
							<span class="cev-authorization__title" style="font-size: <?php echo wp_kses_post( $cev_button_text_header_font_size ); ?>px;">
								...
								$heading = get_option( 'cev_login_auth_header'); 
								if ( !empty($heading) ) { 
						...
						<?php if ( 0 == $cev_login_hide_otp_section ) { ?>
								<div class="cev-pin-verification">
									...
									<div class="cev-pin-verification__events">
										...
										<?php 
										$verify = get_option( 'cev_login_auth_button_text' );
										if ( !empty($verify) ) { 
						...
						<?php 
							$CEV_Customizer_Options = new CEV_Customizer_Options();
							$footer_message = get_option( 'cev_login_auth_widget_footer', $CEV_Customizer_Options->defaults['cev_login_auth_widget_footer']);
